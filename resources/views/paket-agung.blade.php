      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h3 style="text-align:center;">2 MC Wanita dan Pria</h3>
            <h3 style="text-align:center;">Vendor Dealing</h3>
            <h3 style="text-align:center;">Limited Meeting</h3>
            ...
            <a href="{{ route('detail-agung')}}"  class="btn btn-primary" type="submit">Beli Paket</a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
            ...
            <h3 style="text-align:center;">Busana Rias 2 Pagar Ayu</h3>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h3 style="text-align:center;">Unlimited Seat And Meeting</h3>
            <h3 style="text-align:center;">Vendor Dealing</h3>
            <h3 style="text-align:center;">Busana Rias Pengantin 2x</h3>
            <h3 style="text-align:center;">Busana Rias 4 Pagar Ayu</h3>
            <h3 style="text-align:center;">+- 600 Undangan</h3>
            <h3 style="text-align:center;">Half Day</h3>
            <h3 style="text-align:center;">(8 Jam Kerja)</h3>
            </div>
            <a href="{{ route('detail-agung')}}" type="submit" class="btn btn-primary">Beli Paket</a>
            </div>
          </div>
        </div>
      </div>
