          ...
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto ">
                ...
                <li><a href="{{ route('contact')}}" class="nav-link">Admin</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <h1><a style="text-align:center;" href="{{ route('index')}}">Half Packager</a></h1>
                <br>
                <h3 style="text-align:center;">Rp 10.000.000</h3>
                <h3 style="text-align:center;">6 Crew WO</h3>
                <h3 style="text-align:center;">+- 500 Undangan</h3>
                <h3 style="text-align:center;">Bonus Honeymoon</h3>
              ...
              <a href="{{ route('detail-his')}}"  class="btn btn-primary" type="submit">Beli Paket</a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <h1><a style="text-align:center;" href="{{ route('index')}}">Self Package</a></h1>
                <br>   
                ...
                <h3 style="text-align:center;">Catering Free</h3>
                <h3 style="text-align:center;">Photograpy</h3>
                <h3 style="text-align:center;">Half Day</h3>
                <h3 style="text-align:center;">(8 Jam Kerja)</h3>
              </div>
              <a href="{{ route('detail-his')}}" class="btn btn-primary" type="submit">Beli Paket</a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>
                <h3 style="text-align:center;">Rp 15.500.000</h3>
                <h3 style="text-align:center;">10 Crew WO</h3>
                <h3 style="text-align:center;">Rias Busana</h3>
                <h3 style="text-align:center;">Dekorasi</h3>
                <h3 style="text-align:center;">+- 800 Undangan</h3>
                <h3 style="text-align:center;">Half Day</h3>
                <h3 style="text-align:center;">(8 Jam Kerja)</h3>
              </div>
              <a href="{{ route('detail-his')}}" type="submit" class="btn btn-primary">Beli Paket</a>
            </div>
          </div>
        </div>
      </div>
