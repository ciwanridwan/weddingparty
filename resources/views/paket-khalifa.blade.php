          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>
            <h3 style="text-align:center;">Rp 9.000.000</h3>
            <h3 style="text-align:center;">8 Crew WO</h3>
            <h3 style="text-align:center;">+- 400 Undangan</h3>
            <h3 style="text-align:center;">2 MC Nasional</h3>
            <h3 style="text-align:center;">Half Day</h3>
            <h3 style="text-align:center;">(8 Jam Kerja)</h3>
            </div>
            <a href="{{ route('detail-khalifa')}}"  class="btn btn-primary" type="submit">Beli Paket</a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>   
            <h3 style="text-align:center;">Rp 11.000.000</h3>
            <h3 style="text-align:center;">10 Crew WO</h3>
            <h3 style="text-align:center;">+- 600 Undangan</h3>
            <h3 style="text-align:center;">2 MC Nasional Pria</h3>
            <h3 style="text-align:center;">Half Day</h3>
            <h3 style="text-align:center;">(8 Jam Kerja)</h3>
            </div>
            <a href="{{ route('detail-khalifa')}}" class="btn btn-primary" type="submit">Beli Paket</a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>
            <h3 style="text-align:center;">Rp 13.500.000</h3>
            <h3 style="text-align:center;">13 Crew WO</h3>
            <h3 style="text-align:center;">+- 800 Undangan</h3>
            <h3 style="text-align:center;">2 MC Nasional Wanita</h3>
            <h3 style="text-align:center;">Half Day</h3>
            <h3 style="text-align:center;">(8 Jam Kerja)</h3>
            </div>
            <a href="{{ route('detail-khalifa')}}" type="submit" class="btn btn-primary">Beli Paket</a>
            </div>
          </div>
        </div>
      </div>
