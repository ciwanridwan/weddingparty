      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>
            <h3 style="text-align:center;">Rp 12.00.000</h3>
            <h3 style="text-align:center;">6 Crew WO</h3>
            <h3 style="text-align:center;">Busana Rias Pengantin 1x</h3>
            <h3 style="text-align:center;">Busana Rias 4 Penerima Buku Tamu</h3>
            <h3 style="text-align:center;">Rias + Kain 2</h3>
            ...
            <a href="{{ route('detail-hera')}}"  class="btn btn-primary" type="submit">Beli Paket</a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
            ...
            <h3 style="text-align:center;">Busana Rias Pengantin 2x</h3>
            <h3 style="text-align:center;">Busana Rias 6 Pasang Pagar Ayu</h3>
            <h3 style="text-align:center;">Busana Rias 6 Penerima Buku Tamu</h3>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h3 style="text-align:center;">Busana Rias Pengantin 4x</h3>
            <h3 style="text-align:center;">Rias Dan Kain 4</h3>
            <h3 style="text-align:center;">Busana Rias 8 Pagar Ayu </h3>
            <h3 style="text-align:center;">Busana Rias 8 Penerima Buku Tamu</h3>
            <h3 style="text-align:center;">+- 600 Undangan</h3>
            <h3 style="text-align:center;">Half Day</h3>
            <h3 style="text-align:center;">(8 Jam Kerja)</h3>
            </div>
            <a href="{{ route('detail-hera')}}" type="submit" class="btn btn-primary">Beli Paket</a>
            </div>
          </div>
        </div>
      </div>
