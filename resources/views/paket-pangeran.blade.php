      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>
            <h3 style="text-align:center;">Rp 6.000.000</h3>
            <h3 style="text-align:center;">6 Crew WO</h3>
            <h3 style="text-align:center;">+- 200 Undangan</h3>
            <h3 style="text-align:center;">Dekorasi Full</h3>
            <h3 style="text-align:center;">Half Day</h3>
            <h3 style="text-align:center;">(8 Jam Kerja)</h3>
            </div>
            <a href="{{ route('detail-pangeran')}}"  class="btn btn-primary" type="submit">Beli Paket</a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              ...
              <div class="post-entry-1-contents">
                ...
                <br>   
            <h3 style="text-align:center;">Rp 8.00.000</h3>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <a href="{{ route('detail-pangeran')}}" type="submit" class="btn btn-primary">Beli Paket</a>
            </div>
          </div>
        </div>
      </div>
